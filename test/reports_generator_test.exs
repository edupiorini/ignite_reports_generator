defmodule ReportsGeneratorTest do
  ...
  describe "fetch_higher_cost/2" do
    test "when option 'users' is given, returns the one who spent the most" do
      file_name = "report_test.csv"
    ...
    test "when option 'foods' is given, returns the most ordered food" do
      file_name = "report_test.csv"
  ...
  describe "build_from_many/1" do
    ...
    test "when a file list is not provided, returns an error" do
      response = ReportsGenerator.build_from_many("any")

      expected_response = {:error, "Incorrect type, please provide a list of strings"}
