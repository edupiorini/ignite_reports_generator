defmodule ReportsGenerator do
  ...
  def build_from_many(filenames) when not is_list(filenames) do
    {:error, "Incorrect type, please provide a list of strings"}
  end

  def build_from_many(filenames) do
    result =
      filenames
      # sintaxe implícita de (fn filenames -> build(filenames)end)
  ...
  defp sum_values([id, food_name, price], %{"foods" => foods, "users" => users}) do
    ...
    # agora usando o build_report para evitar repetições
